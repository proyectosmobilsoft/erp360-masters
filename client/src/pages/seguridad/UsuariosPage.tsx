...
import { Edit, Trash2, Plus, Search, Users, Save, RefreshCw, Loader2, Lock, CheckCircle, User, ImagePlus, UtensilsCrossed } from "lucide-react";
          ...
          <div className="bg-white rounded-lg border">
            ...
            <div className="relative overflow-x-auto rounded-lg shadow-sm">
              {(isLoading || isRefreshing) && (
                <div className="absolute inset-0 flex items-center justify-center bg-white/70 z-20">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-gray-600 font-semibold">{isRefreshing ? 'Actualizando usuarios...' : 'Cargando usuarios...'}</span>
                  </div>
                </div>
              )}
              <Table className="min-w-[900px] w-full text-xs">
                ...
                <TableBody>
                  {!(isLoading || isRefreshing) && (usuariosFiltrados.length === 0 ? (
                    <TableRow>
