                ...
                <Table>
                  <TableHeader className="bg-cyan-50">
                    <TableRow className="text-center font-semibold text-gray-700">
                      ...
                      <TableHead className="px-4 py-3 w-20 text-center">ID</TableHead>
                      <TableHead className="px-4 py-3 text-center">Nombre</TableHead>
                      <TableHead className="px-4 py-3 text-center">Es Receta</TableHead>
                      <TableHead className="px-4 py-3 text-center">Requiere Empaques</TableHead>
